...
var config = zap.Config{
	...
	OutputPaths:      []string{"stderr", "NewProtocol5.log"}, // Logs to both stderr and the file
...
func (p *PasswordSafeProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	httpClientObj, _ := utils.GetHttpClient(clientTimeOutInSeconds, providerData.verifyca, "", "", zapLogger)
